import icons from 'url:../../img/icons.svg'; // code for parcel, so svgs with relative paths are shown
import * as fracty from 'fracty';
import View from './View.js';

class RecipeView extends View {
  _parentElement = document.querySelector('.recipe');
  _errorMessage = `Couldn't load the recipe`;
  _message = ``;
    ...
    return `
      ...
      this._data.bookmarked ? '-fill' : ''
            ...
            ${this._data.ingredients
              .map(this._generateMarkupIngredient) // nice
              .join('')}
            </ul>
            </div>
